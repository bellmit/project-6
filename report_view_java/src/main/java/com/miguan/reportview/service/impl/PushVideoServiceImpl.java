...
@Service
@Slf4j
public class PushVideoServiceImpl  implements PushVideoService {
     ...
     * @return
     */
    public List<PushVideoResultDto> findAutoPushList(Integer userType, String packageName, String dd, Integer pageNum, Integer pageSize) {
        Map<String, Object> params = new HashMap<>();
        ...
        List<PushVideoResultDto> pageList = pushVideoMapper.findPushVideosResult(params);
        return pageList;
    }
}
