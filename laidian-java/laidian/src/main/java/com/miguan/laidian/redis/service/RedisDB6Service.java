...
import com.miguan.laidian.redis.util.SerializeUtil;
 ...
 * database6
 * */
@Service(value="redisDB6Service")
public class RedisDB6Service {

    @Resource(name="dB6Pool")
    JedisPool dB6Pool;
