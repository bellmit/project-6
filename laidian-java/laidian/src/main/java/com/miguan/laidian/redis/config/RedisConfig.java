...
public class RedisConfig {
    ...
    public JedisPool dB6Pool(){
        ...
        jedisPoolConfig.setMaxTotal(Integer.valueOf(environment.getProperty("spring.redis.jedis.pool.max-active")));
        jedisPoolConfig.setMaxWaitMillis(Integer.valueOf(environment.getProperty("spring.redis.jedis.pool.max-wait")));
        JedisPool jedisPool = new JedisPool(jedisPoolConfig, environment.getProperty("spring.redis.ballvideoHost"),
                Integer.valueOf(environment.getProperty("spring.redis.ballvideoPort")), Integer.valueOf(environment.getProperty("spring.redis.ballvideoTimeOut")),environment.getProperty("spring.redis.ballvideoPassword"),6);
        return jedisPool;
    }
}
