package com.miguan.laidian.springTask.config;

import com.miguan.laidian.springTask.handler.SpringAsyncExceptionHandler;
...
public class ScheduleConfig implements SchedulingConfigurer, AsyncConfigurer {
    ...
    public static Log log = LogFactory.getLog(ScheduleConfig.class);
