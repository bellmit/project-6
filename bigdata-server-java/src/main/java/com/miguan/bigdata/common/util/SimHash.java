...
//    }
    ...
    public static double getSemblance(SimHash s1, SimHash s2) {
        double i = (double) s1.hammingDistance(s2);
        return 1 - i/64 ;
    }
    ...
    public static void main(String[] args) {
        ...
        String a = "疯狂找上门报复，心机女惨遭富二代抛弃，直接一刀解决了富二代！";
        String b = "富二代惨遭富二代抛弃，疯狂找上门报复，直接一刀解决了富二代！";
        SimHash hash6 = new SimHash(a);
        SimHash hash7 = new SimHash(b);
        double  c = hash7.getSemblance(hash6);
        long l6 = System.currentTimeMillis();
//        System.out.println(l6-l5);
//        System.out.println(hash6.hammingDistance(hash7));
//        System.out.println(hash6.getSemblance(hash7));
        long aaa = System.currentTimeMillis();
        double aa = SimHash.getSemblance(hash6, hash7);
