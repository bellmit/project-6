package com.miguan.flow.service.common;

import com.alibaba.fastjson.JSON;
import com.miguan.flow.common.constant.RedisConstant;
import com.miguan.flow.common.util.SerializeUtil;
 ...
 */
@Service
public class RedisAdvertService {

    @Resource(name="advertPool")
    ...
    public void hset(String key,String field,String value,int secondes) {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
    ...
    public String getSysConfigValue(String key) {
        return this.get(RedisConstant.CONFIG_CODE_PRE + key);
    }
    ...
    public int getInt(String key) {
        return Integer.parseInt(getSysConfigValue(key));
    }
    ...
    public double getDouble(String key) {
        return Double.parseDouble(getSysConfigValue(key));
    }
}
