...
@Setter
@Getter
@Document(MongoConstants.incentive_video_hotspot)
@NoArgsConstructor
@AllArgsConstructor
@ApiModel
public class IncentiveVideoHotspot {
    ...
    public IncentiveVideoHotspot(RecVideosVo recVideosVo, Integer albumId, Double weights, Double weights1, List<FullLable> top5_ids) {
        Date date = new Date();
