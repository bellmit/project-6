...
import com.miguan.recommend.common.constants.Constants;
...
import static com.cgcg.context.util.HttpUtil.APPLICATION_JSON;
...
//    }
    ...
    public static String postClient(String clientURL, Map<String, String> params, String charset, int timeout) {
        ...
        try {
            ...
            result = initResult(Constants.TIMEOUT_CODE_VALUE, "请求超时");
            log.info("请求发送失败，SocketTimeoutException原因：", e);
        } catch (ClientProtocolException e) {
            result = initResult(Constants.CLIENT_EXCEPTION_CODE_VALUE, "请求异常，ClientProtocolException");
            log.info("请求发送失败，ClientProtocolException原因：", e);
        } catch (UnsupportedEncodingException e) {
            result = initResult(Constants.CLIENT_EXCEPTION_CODE_VALUE, "请求异常，UnsupportedEncodingException");
            log.info("请求发送失败，UnsupportedEncodingException原因：", e);
        } catch (IOException e) {
            result = initResult(Constants.CLIENT_EXCEPTION_CODE_VALUE, "请求异常，IOException");
            ...
            try {
                ...
                result = initResult(Constants.CLIENT_EXCEPTION_CODE_VALUE, "请求异常");
    ...
    public static String initResult(int code, String msg) {
        ...
        data.put(Constants.RESPONSE_CODE, code);
        data.put(Constants.RESPONSE_CODE_MSG, msg);
...
//    }
    ...
    public static String doPost(String uri, String param) {
        try {
            return doPost(uri, param, 30000);
        } catch (Exception e) {
            log.error("doPost IOException ", e.getMessage());
            log.error("doPost请求异常：uri=" + uri + ", param=" + param);
            return "";
        }
    }
