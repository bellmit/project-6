...
public abstract class RedisService {
    ...
    public <T> Long incr(String key, int second) {
        Jedis jedis = null;
        try {
            jedis = getJedisPool().getResource();
    ...
    public <T> boolean hexits(String key, String field) {
        Jedis jedis = null;
        try {
            jedis = getJedisPool().getResource();
    ...
    public long hiner(String key, String field, long value, int secondes) {
        Jedis jedis = null;
        try {
            jedis = getJedisPool().getResource();
    ...
    public void hmset(String key, Map<String, String> value, int secondes) {
        Jedis jedis = null;
        try {
            jedis = getJedisPool().getResource();
            jedis.hmset(key, value);
