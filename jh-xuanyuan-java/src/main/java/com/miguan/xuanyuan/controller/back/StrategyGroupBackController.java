...
@Slf4j
@RestController
@RequestMapping("/api/back/strategy")
public class StrategyGroupBackController extends AuthBaseController {
    ...
    @LogInfo(pathName="后台-策略聚合管理-修改ab实验状态",plat= XyConstant.BACK_PLAT,type = XyConstant.LOG_UPDATE)
    ...
    @LogInfo(pathName="后台-策略聚合管理-保存策略代码位",plat= XyConstant.BACK_PLAT,type = XyConstant.LOG_UPDATE)
    ...
    @LogInfo(pathName="后台-策略聚合管理-新增ab实验",plat= XyConstant.BACK_PLAT,type = XyConstant.LOG_ADD)
    ...
    @LogInfo(pathName="后台-策略聚合管理-编辑ab实验",plat= XyConstant.BACK_PLAT,type = XyConstant.LOG_UPDATE)
