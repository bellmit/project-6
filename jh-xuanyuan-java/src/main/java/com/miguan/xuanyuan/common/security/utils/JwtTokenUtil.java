package com.miguan.xuanyuan.common.security.utils;
...
public class JwtTokenUtil implements Serializable {
    ...
    private static String secret = "sWl8ZuVEpGpC4IXhtB3LZtgFW8lRj1GU"; //密钥
    private static Long timeout = 60 * 60 * 8 * 1000L;//8小时
