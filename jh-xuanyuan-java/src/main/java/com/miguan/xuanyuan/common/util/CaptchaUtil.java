...
public class CaptchaUtil {
     ...
     * @return
     */
    public boolean checkLoginValidateCode(HttpServletRequest request, String validateCode) {
        String loginValidateCode = (String)request.getSession().getAttribute(CaptchaUtil.LOGIN_VALIDATE_CODE);
        if (StringUtils.isNotEmpty(loginValidateCode) && loginValidateCode.equals(validateCode)) {
            return true;
        }
        return false;
    }
