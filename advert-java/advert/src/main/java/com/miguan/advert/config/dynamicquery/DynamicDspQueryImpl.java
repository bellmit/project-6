...
import com.miguan.advert.config.dynamicquery.former.MyResultTransformer;
...
@Slf4j
@Repository
public class DynamicDspQueryImpl implements DynamicDspQuery {

	@PersistenceContext(unitName = "dspEntityManagerFactory")
