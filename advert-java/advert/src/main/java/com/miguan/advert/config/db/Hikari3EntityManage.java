...
public class Hikari3EntityManage {
    ...
    public LocalContainerEntityManagerFactoryBean entityManageFactory(EntityManagerFactoryBuilder builder){
        LocalContainerEntityManagerFactoryBean entityManagerFactory =  builder.dataSource(thirddatasource)
                .packages("com.miguan.advert.domain.entity").persistenceUnit("Hikari3EntityManage").build();
        ...
        jpaProperties.put("hibernate.hbm3ddl.auto", environment.getProperty("spring.jpa.hibernate.ddl-auto"));
