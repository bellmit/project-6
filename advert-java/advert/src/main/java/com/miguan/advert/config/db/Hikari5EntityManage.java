...
public class Hikari5EntityManage {
    ...
    @Resource
    private HikariDataSource fifthdatasource;
    ...
    public LocalContainerEntityManagerFactoryBean entityManageFactory(EntityManagerFactoryBuilder builder){
        LocalContainerEntityManagerFactoryBean entityManagerFactory =  builder.dataSource(fifthdatasource)
                .packages("com.miguan.advert.domain.entity").persistenceUnit("Hikari5EntityManage").build();
        ...
        jpaProperties.put("hibernate.hbm5ddl.auto", environment.getProperty("spring.jpa.hibernate.ddl-auto"));
