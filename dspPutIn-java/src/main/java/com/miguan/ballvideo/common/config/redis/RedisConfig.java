...
public class RedisConfig {
    ...
    public JedisPool recPool(){
        ...
        JedisPool jedisPool = new JedisPool(jedisPoolConfig, environment.getProperty("spring.redis.rec.host"),
                Integer.valueOf(environment.getProperty("spring.redis.rec.port")), Integer.valueOf(environment.getProperty("spring.redis.timeout")),environment.getProperty("spring.redis.rec.password"),Integer.valueOf(environment.getProperty("spring.redis.rec.database")));
        return jedisPool;
    }
