...
import com.cgcg.context.util.Base64Util;
...
public class AESUtils {
    ...
    public static void main(String[] args) {
        ...
        String enckey = AESUtils.encrypt("85663914-356f-164f-92f3-4a13fb619481","ext-api@98du");//加密
        String deckey = AESUtils.decrypt(enckey,"ext-api@98du");//解密
    }
}
