...
public interface PushArticleMobileService {
    ...
    //youMengIos推送
    List<Map> youMengIosPushInfo(Map<String, Object> pushParams, Map<String, String> params, String deviceTokens);

    //youMengAndroid推送
    List<Map> youMengAndroidPushInfo(Map<String, Object> pushParams, Map<String, String> params, String deviceTokens);

    //youMengIos推送
    List<Map> youMengIosPushInfoByToken(Map<String, Object> pushParams, Map<String, String> params,List<String> tokens);

    //youMengAndroid推送
    List<Map> youMengAndroidPushInfoByToken(Map<String, Object> pushParams, Map<String, String> params,List<String> tokens);
