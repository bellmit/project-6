package com.miguan.report.common.dynamicquery.impl;

import com.miguan.report.common.dynamicquery.DynamicQuery4LaiDian;
import com.miguan.report.common.dynamicquery.former.MyResultTransformer;
...
@Slf4j
@Repository
public class DynamicQuery4LaiDianImpl implements DynamicQuery4LaiDian {

    @PersistenceContext(unitName = "entityManagerFactory4LaiDian")
